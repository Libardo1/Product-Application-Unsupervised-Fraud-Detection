...
######################### Repeat Following Process for 7-day Time Window #########################
######################### 3-day Time Window #########################
...
expert_app = data[849:100000,13:28]
...
save(finaldata, file = "finaldata_1.rda")
...
fraud_compare(0.01) #top 1% (1000 records): 94% matched
fraud_compare(0.001) #top 0.1% (100 records): 97% matched
fraud_compare(percentage = NULL, cut_off = 100) #top 100: 97 matched
fraud_compare(percentage = NULL, cut_off = 10) #top 10: 1 matched
...
write.csv(overlap_top10, file = "overlap_top10.csv")
